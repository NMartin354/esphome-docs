...
-  **attempts_timeout** (*Optional*, :ref:`config-time`): The amount of time to wait before resetting the safe mode counter
   rebooting when in safe mode. Defaults to ``5min``.
